...
<head>
    ...
    <title>GUI PEDIDOS CLIENTES</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Gestionar Pedidos de Clientes <small>CRUD de Pedidos de Clientes y su detalle</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                ...
                <div class="card" id="detalles" style="display:none">
                    ...
                    <div class="card" id="registros">
                        <div class="header">
                            <h2>Registros de Pedidos de Clientes</h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
