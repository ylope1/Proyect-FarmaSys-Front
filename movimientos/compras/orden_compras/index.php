...
<head>
    ...
    <title>GUI ORDEN DE COMPRA</title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Gestionar Ordenes de Compras <small>CRUD de Ordenes de Compras y sus detalles</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <!-- CAMPO PARA ELEGIR CONDICION DE COMPRA -->
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="demo-radio-button">
                                        <div>
                                            <input type="radio" id="Con_Presupuesto" name="presupuesto_option" value="1" disabled>
                                            <label for="Con_Presupuesto">Sí</label>

                                            <input type="radio" id="Sin_Presupuesto" name="presupuesto_option" value="0" disabled>
                                ...
                                <!-- CAMPO PARA BUSCAR PRESUPUESTO CON 4 COLUMNAS -->
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="hidden" id="presup_comp_id" value="0"/>
                                            <input type="text" id="presupuesto" class="form-control" disabled onkeyup="buscarPresupuesto();">
                                            <label class="form-label">Presupuesto</label>
                                        </div>
                                        <div id="listaPresupuestos" style="display:none;"></div>
                                    </div>
                                </div>
                            </div>    
                    ...
                    <div class="card" id="detalles" style="display:none"> 
                        ...
                        <div class="card" id="registros">
                            <div class="header">
                                <h2>Registros de Ordenes de Compras</h2>
                            </div>
                            <div class="body">
                                <div class="table-responsive">
