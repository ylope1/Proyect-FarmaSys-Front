    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER TIPOS DE IMPUESTOS</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Tipos de Impuestos <small>CRUD de Tipos de Impuestos</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Tipos de Impuestos</h2>
                        </div>
                        <div class="body">
