    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER MOTIVOS DE AJUSTES</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Motivos de Ajustes <small>CRUD de Motivos de Ajustes</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Motivos de Ajustes</h2>
                        </div>
                        <div class="body">
