        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Stocks <small>CRUD de Stocks</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" id="deposito_descrip" class="form-control" disabled onkeyup="buscarDepositos();">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" id="prod_descrip" class="form-control" disabled onkeyup="buscarProductos();">
                                            <label class="form-label">Producto</label>
                                        </div>
                                        <div id="listaProductos" style="display:none;"></div>
                                    </div>
                                </div>
                                <!-- CAMPO PARA CANTIDAD EXISTENCIA CON 4 COLUMNAS -->
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="txtCantExis" class="form-control" disabled>
                                            <label class="form-label">Existencia</label>
                                        </div>
                                    </div>
                                </div>
                                <!-- CAMPO PARA CANTIDAD MINIMA CON 4 COLUMNAS -->
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="txtCantMin" class="form-control" disabled>
                                            <label class="form-label">Stock Minimo</label>
                                        </div>
                                    </div>
                                </div>
                                <!-- CAMPO PARA CANTIDAD MAXIMA CON 4 COLUMNAS -->
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="txtCantMax" class="form-control" disabled>
