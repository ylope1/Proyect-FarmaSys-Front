        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Usuarios <small>CRUD de Usuarios</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="txtNombre" class="form-control" disabled maxlength="255">
                                            <label class="form-label">Nombre</label>
                                        </div>
                                    </div>
                                </div>
                                <!--CAMPO PARA LOGIN CON 5 COLUMNAS-->
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" id="txtLogin" class="form-control" disabled maxlength="50">
                                            <label class="form-label">Login</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <!--CAMPO PARA EMAIL CON 5 COLUMNAS-->
                                    <div class="col-sm-5">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="txtEmail" class="form-control" disabled maxlength="255">
                                                <label class="form-label">Email</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!--CAMPO PARA CONTRASEÑA CON 4 COLUMNAS-->
                                    <div class="col-sm-4">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="txtPassword" class="form-control" disabled maxlength="100">
                                                <label class="form-label">Contraseña</label>
                                            </div>
                                        </div>
                                    </div>
                                    <!--CAMPO PARA INTENTOS CON 3 COLUMNAS-->
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="txtIntentos" class="form-control" disabled>
                                ...
                                <div class="row clearfix">    
                                    <!--CAMPO PARA ROL CON 6 COLUMNAS-->
                                    <div class="col-sm-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select id="txtRol" class="form-control selectpicker" disabled>
                                    ...
                                    <!--CAMPO PARA ESTADO CON 6 COLUMNAS-->
                                    <div class="col-sm-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                            ...
                            <div class="button-demo" style="margin-top: 20px;">
                                ...
                                <button type="button" id="btnDesbloquear" class="btn btn-info waves-effect" onclick="desbloquear();">DESBLOQUEAR</button>
