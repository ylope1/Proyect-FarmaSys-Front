    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER MARCAS DE TARJETAS</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Marcas Tarjetas <small>CRUD de Marcas Tarjetas</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <!-- CAMPO PARA SELECCIONAR ESTADO CON 5 COLUMNAS -->
                                <div class="col-sm-5">
