    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER FORMAS DE COBROS</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Formas de Cobros <small>CRUD de Formas de Cobros</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Formas de Cobros</h2>
                        </div>
                        <div class="body">
