    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER ENTIDADES ADHERIDAS</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Entidades Adheridas <small>CRUD de Entidades Adheridas</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <!-- CAMPO PARA DIRECCION CON 5 COLUMNAS -->
                                <div class="col-sm-5">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Entidades Adheridas</h2>
                        </div>
                        <div class="body">
