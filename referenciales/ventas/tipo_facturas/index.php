    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>MANTENER Tipos de Facturas</h2>
            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Mantener datos de Tipos de Facturas <small>CRUD de Tipos de Facturas</small> </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Registros de Tipos de Facturas</h2>
                        </div>
                        <div class="body">
